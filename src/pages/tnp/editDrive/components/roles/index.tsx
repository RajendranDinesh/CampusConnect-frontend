    ...
    return (
        <div className=" w-full pb-4 " onClick={() => setActiveDropDown(null)}>
            <div className=" mx-6 flex flex-col rounded-md bg-secondary-color shadow-md md:mx-0 md:min-w-full ">
                <h1 className=" px-4 pt-4 text-2xl font-medium text-text-accent-color ">Roles</h1>
                                    ...
                                    {companies
                                        ...
                                        .roles.map((role, index) => (
                                            <tr className="border-b border-neutral-200 hover:bg-neutral-100" key={index}>
                                                ...
                                                <td className="whitespace-nowrap text-wrap px-6 py-4 ">{role.name}</td>
                                                <td className="whitespace-nowrap px-6 py-4">{role.availability}</td>
                                                <td className="whitespace-nowrap px-6 py-4">
                                                    {role.expectedSalray[0]} - {role.expectedSalray[1]}
                                                </td>
                                                <td className="whitespace-nowrap px-6 py-4">
                                                    <button
                                                        onClick={(e) => {
