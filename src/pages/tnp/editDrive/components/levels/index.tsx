...
export default function Levels(props: Props) {
    ...
    return (
        <div className=" w-full pb-4 " onClick={() => setActiveDropDown(null)}>
            <div className=" mx-6 flex flex-col rounded-md bg-secondary-color shadow-md md:mx-0 md:min-w-full ">
                <h1 className=" px-4 pt-4 text-2xl font-medium text-text-accent-color ">Levels</h1>
                                    ...
                                    {companies
                                        ...
                                        .levels.map((level, index) => (
                                            <tr className="border-b border-neutral-200 hover:bg-neutral-100" key={index}>
                                                ...
                                                <td className="whitespace-nowrap text-wrap px-6 py-4 ">{level.name}</td>
                                                <td className="whitespace-nowrap px-6 py-4">{level.conductedBy}</td>
                                                <td className="whitespace-nowrap px-6 py-4">{level.criteria}</td>
