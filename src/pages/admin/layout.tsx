                        ...
                        <div className="flex justify-between">
                            <div className="flex space-x-4">
                                ...
                                <div className="hidden flex-col items-center space-x-1 py-4 md:flex">
                                    <a href="/admin" className="flex-col items-center px-3 text-text-color md:flex">
                                ...
                                <div className="hidden flex-col items-center space-x-1 py-4 md:flex">
                                    <a href="/admin/settings" className="flex-col items-center px-3 text-text-color md:flex">
                                        <img width="24" height="24" src="https://img.icons8.com/pulsar-line/48/user-settings.png" alt="user-settings" />
                                        Account
                                    </a>
                                </div>
                            </div>
