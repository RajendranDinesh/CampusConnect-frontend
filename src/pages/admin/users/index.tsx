    ...
    return (
        <div>
            <div className=" flex w-full bg-background-color p-4 md:p-16 ">
                <div className=" w-full ">
                    <div className=" w-full rounded-md bg-secondary-color py-2 shadow-md " onClick={() => setActiveDropDown(null)}>
                        <h1 className=" px-4 text-3xl text-text-accent-color ">Students</h1>
                                ...
                                <tbody>
                                    {students.map((student, index) => (
                                        <tr className="border-b border-neutral-200 hover:bg-neutral-100" key={index}>
                                            ...
                                            <td className="whitespace-nowrap text-wrap px-6 py-4 ">{student.name}</td>
                                            <td className="whitespace-nowrap px-6 py-4">{student.regNo}</td>
                                            <td className="whitespace-nowrap px-6 py-4">{student.email}</td>
                                            <td className="whitespace-nowrap px-6 py-4">{student.companiesAttended}</td>
            ...
            <div className=" flex w-full bg-background-color p-4 md:p-16 ">
                <div className=" w-full ">
                    <div className=" w-full rounded-md bg-secondary-color py-2 shadow-md " onClick={() => setActiveDropDown(null)}>
                        <h1 className=" px-4 text-3xl text-text-accent-color ">Alumni</h1>
                        <div className=" overflow-x-auto md:overflow-hidden ">
                            <table className=" text-surface w-full text-left text-sm font-light">
                                <thead className="border-b border-neutral-200">
                                    <tr>
            ...
            <div className=" flex w-full bg-background-color p-4 md:p-16 ">
                <div className=" w-full ">
                    <div className=" w-full rounded-md bg-secondary-color py-2 shadow-md " onClick={() => setActiveDropDown(null)}>
                        <h1 className=" px-4 text-3xl text-text-accent-color ">Faculties</h1>
                        <div className=" overflow-x-auto md:overflow-hidden ">
                            <table className=" text-surface w-full text-left text-sm font-light">
                                <thead className="border-b border-neutral-200">
                                    <tr>
